...
{
	os << "Distance Traveled: " << metrics.m_TotalDistanceTraveled << std::endl;
	os << "Time in Flight: " << metrics.m_TimeInFlight << std::endl;
	os << "Time Waiting: " << metrics.m_TimeWaiting << std::endl;
	os << "Time Charging: " << metrics.m_TimeCharing << std::endl;
